...
///
var palette = [
  <ReactKonva.Rect x={30} y={35} width={40} height={40} stroke='blue' strokeWidth={5} opacity={0.5} paletteItem={true}/>,
  <ReactKonva.Circle x={150} y={55} radius={20}  stroke='red' strokeWidth={5} opacity={0.5} paletteItem={true}/>,
  <ReactKonva.Text x={200} y={50} text="text" fontSize={16} fontFamily="Helvetica Neue" fontStyle="bold" fill="darkgray" paletteItem={true}/>,
  <ReactKonva.Line points={[300, 40, 320, 65]} stroke='green' strokeWidth={5} opacity={0.5} paletteItem={true}/>,
...
var Canvas = React.createClass({
  ...
  render: function () {
    ...
    var paletteNodes = palette.map(function (item) {
      return item;
    });
